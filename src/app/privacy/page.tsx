...
const PrivacyPage = () => {
	...
	useEffect(() => {
		document.title = "Privacy Policy - SatiricTech";
					...
					<div className="max-w-3xl mx-auto">
						...
						>
							<div className="space-y-4">
								...
								<p>
									SatiricTech ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.
								</p>
								<p>
									We reserve the right to make changes to this Privacy Policy at any time and for any reason. We will alert you about any changes by updating the "Last Updated" date of this policy. Any changes or modifications will be effective immediately upon posting the updated Privacy Policy on the website.
								</p>
							</div>
							...
							<div className="space-y-4">
								...
								<p>
									When you interact with our website, we may collect personal data that can be used to contact or identify you, such as:
								</p>
						...
						>
							<div className="space-y-4">
								...
								<ul className="list-disc pl-6 space-y-2">
									...
									<li>Send you emails (if you've subscribed to our newsletter)</li>
						...
						>
							<div className="space-y-4">
								...
								<ul className="list-disc pl-6 space-y-2">
									<li><strong>Legal Requirements:</strong> To comply with a legal obligation</li>
									...
									<li><strong>With Your Consent:</strong> With your consent in any other cases</li>
									<li><strong>Other:</strong> To our trusted third-party service providers who assist us in operating our website and conducting our business</li>
								</ul>
							</div>
							...
							<div className="space-y-4">
								...
								<p className="mt-4">
									To exercise any of these rights, please contact us at privacy@satirictech.com.
								</p>
							</div>
						</div>
					</div>
