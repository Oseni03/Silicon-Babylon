...
const allArticles: Article[] = [
  ...
  },
  {
    ...
    excerpt: "Scientists baffled as Elon Musk claims to have broken the laws of physics with SpaceX's latest reusable rocket that 'just keeps getting better with age.'",
    date: "2023-04-28",
    category: "Space"
  },
  {
    ...
    excerpt: "Silicon Valley's newest venture aims to help companies disrupt industries that are already being disrupted by other disruptive startups.",
    date: "2023-04-25",
    category: "Startups"
  },
  {
    ...
    excerpt: "Tim Cook insists that the new cable, made from 'responsibly sourced' precious metals, represents the 'future of charging and personal expression.'",
    date: "2023-04-22",
    category: "Products"
  },
  {
    ...
    excerpt: "In a move towards transparency, Twitter has simplified its algorithm to directly query users about their current rage levels.",
    date: "2023-04-19",
    category: "Social Media"
  },
  {
    ...
    excerpt: "Developers claim the app, called 'ConsensUs,' eliminates bad pickup lines through a democratic review process.",
    date: "2023-04-15",
    category: "Blockchain"
  },
  {
    ...
    excerpt: "The groundbreaking processor requires users to verbally praise their computer at least once every hour to maintain optimal performance.",
    date: "2023-04-12",
    category: "Hardware"
  }
];
      ...
      <main className="flex-grow pt-24">
        <section className="container mx-auto px-6 py-16">
          <div className="max-w-4xl mx-auto text-center mb-12 space-y-2">
            <h1 className="text-4xl font-medium tracking-tight">Article Archive</h1>
